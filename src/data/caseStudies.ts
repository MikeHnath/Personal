...
export const caseStudies: CaseStudy[] = [
  {
    ...
    title: 'Building a cannabis chocolate brand from zero to five states',
    subtitle:
      '9 years of brand development, product commercialization, and multi-state packaging production for a regulated cannabis brand — from first logo to active line extension.',
